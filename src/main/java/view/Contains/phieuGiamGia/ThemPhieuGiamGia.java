...
//        sdf = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public void validates() {
        ...
        String batDau = sdf.format(bd);
        String ketThuc = sdf.format(kt);
        ...
        if (String.valueOf(now).compareTo(batDau) < 0) {
            JOptionPane.showMessageDialog(this, "Chương trình chưa diễn ra");
            return;
        }
        if (String.valueOf(now).compareTo(batDau) == 0) {
            JOptionPane.showMessageDialog(this, "Chương trình đang diễn ra");
            return;
        }
        if (String.valueOf(now).compareTo(ketThuc) > 0) {
            JOptionPane.showMessageDialog(this, "Chương trình đã diễn ra");
            return;
        }

//        String batDau = sdf.format(txtNgayBatDau.getDate());
//        String ketThuc = sdf.format(txtNgayKetThuc.getDate());
        if (batDau.compareTo(ketThuc) < 1) {
...
//        validate();
//if(txtTenPhieu.getText().trim().equals("")){
//            JOptionPane.showMessageDialog(this, "Bạn chưa nhập tên phiếu");
//        return;
//        }
        validate();
